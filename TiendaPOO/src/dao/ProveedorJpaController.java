...
public class ProveedorJpaController implements Serializable {
    ...
    public void create(Proveedor proveedor) throws PreexistingEntityException, Exception {
        if (proveedor.getEmpleadoCollection() == null) {
            proveedor.setEmpleadoCollection(new ArrayList<Empleado>());
        }
        ...
        try {
            ...
            for (Empleado empleadoCollectionEmpleadoToAttach : proveedor.getEmpleadoCollection()) {
            ...
            proveedor.setEmpleadoCollection(attachedEmpleadoCollection);
            em.persist(proveedor);
            for (Empleado empleadoCollectionEmpleado : proveedor.getEmpleadoCollection()) {
                empleadoCollectionEmpleado.getProveedorCollection().add(proveedor);
    ...
    public void edit(Proveedor proveedor) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Collection<Empleado> empleadoCollectionOld = persistentProveedor.getEmpleadoCollection();
            Collection<Empleado> empleadoCollectionNew = proveedor.getEmpleadoCollection();
            ...
            proveedor.setEmpleadoCollection(empleadoCollectionNew);
            ...
            for (Empleado empleadoCollectionOldEmpleado : empleadoCollectionOld) {
                if (!empleadoCollectionNew.contains(empleadoCollectionOldEmpleado)) {
                    empleadoCollectionOldEmpleado.getProveedorCollection().remove(proveedor);
            ...
            for (Empleado empleadoCollectionNewEmpleado : empleadoCollectionNew) {
                if (!empleadoCollectionOld.contains(empleadoCollectionNewEmpleado)) {
                    empleadoCollectionNewEmpleado.getProveedorCollection().add(proveedor);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Collection<Empleado> empleadoCollection = proveedor.getEmpleadoCollection();
            for (Empleado empleadoCollectionEmpleado : empleadoCollection) {
                empleadoCollectionEmpleado.getProveedorCollection().remove(proveedor);
                empleadoCollectionEmpleado = em.merge(empleadoCollectionEmpleado);
            }
            em.remove(proveedor);
            em.getTransaction().commit();
